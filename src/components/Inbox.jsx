                ...
                <div className='flex items-center gap-1'>
                    {
                        mailType.map((item, index) =>
                            <button
                                key={index}
                                className={`flex items-center gap-4 p-4 ${mailTypeSelected === index ? 'border-b-4 border-b-blue-600 text-blue-600' : 'border-b-4 border-b-transparent'} w-60 hover:bg-gray-100`}
                                onClick={() => {
